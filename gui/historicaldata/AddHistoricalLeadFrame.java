...
public class AddHistoricalLeadFrame extends JDialog implements ActionListener
{
	...
	public AddHistoricalLeadFrame(BackendManager backendMgr, String[] days, String[] months, String[] years, String[] stages, String[] clients)
	{
   ...
   private void setUpGUI()
   {
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		else if(e.getSource() == saveButton)
		{
			...
			if(backendManager.addHistoricalLead(newClientCheckBox.isSelected(), clientNameComboBox.getSelectedIndex(), dealDayComboBox.getSelectedItem(), dealMonthComboBox.getSelectedItem(), dealYearComboBox.getSelectedItem(), dealValueTextBox.getText(), stageOfNegotiationsComboBox.getSelectedIndex(), succeededCheckBox.isSelected()))
				dispose();
		}
	}
}  