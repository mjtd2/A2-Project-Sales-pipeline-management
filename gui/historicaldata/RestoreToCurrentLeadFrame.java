...
public class RestoreToCurrentLeadFrame extends JDialog implements ActionListener
{
	...
	final int mHistoricalLeadID;
	
	public RestoreToCurrentLeadFrame(BackendManager backendMgr, String[] days, String[] months, String[] years, String[] stages, String[] clients, int clientID, String dealDay, String dealMonth, String dealYear, int stageOfNegotiationsID, int probability, int value, int historicalLeadID, int[] defaultProbabilities)
	{
		...
		this.value = value;
		mHistoricalLeadID = historicalLeadID;
   ...
   private void setUpGUI()
   {
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		else if(e.getSource() == saveButton)
		{
			...
			if(backendManager.restoreToCurrent(clientNameComboBox.getSelectedIndex(), dealDayComboBox.getSelectedItem(), dealMonthComboBox.getSelectedItem(), dealYearComboBox.getSelectedItem(), dealValueTextBox.getText(), stageOfNegotiationsComboBox.getSelectedIndex(), probabilitySpinner.getValue(), mHistoricalLeadID, newClientCheckBox.isSelected()))
				dispose();
		}
	}
}  