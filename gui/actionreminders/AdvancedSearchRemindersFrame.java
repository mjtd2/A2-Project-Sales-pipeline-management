...
public class AdvancedSearchRemindersFrame extends JDialog implements ActionListener 
{
	...
	JCheckBox notMessageCheckBox = new JCheckBox();
	...
	public AdvancedSearchRemindersFrame(BackendManager backendManager, String[] days, String[] months, String[] years, String[] clients, String[] probabilitiesInPercent)
	{
	...
	public void setUpGUI()
	{
		...
		messageLabel.setLocation(330,120);
		...
		reminderMessageScrollPane.setLocation(330, 140);
		reminderMessageScrollPane.setSize(325, 45);
		getContentPane().add(reminderMessageScrollPane);

		notMessageCheckBox.setLocation(613,120);
		notMessageCheckBox.setSize(50,20);
		notMessageCheckBox.setText("NOT");
		getContentPane().add(notMessageCheckBox);
