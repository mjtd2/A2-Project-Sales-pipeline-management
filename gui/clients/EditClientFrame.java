...
public class EditClientFrame extends JDialog implements ActionListener
{
	...
	public EditClientFrame(BackendManager backendMgr, String clientName, String emailAddress, String phoneNumber, int clientID)
	{
   ...
   private void setUpGUI()
   {
		...
		clientNameTextBox = new JTextField(mClientName);
		...
		phoneNumberTextBox = new JTextField(mPhoneNumber);
		...
		emailAddressTextBox = new JTextField(mEmailAddress);
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		else if(e.getSource() == saveButton)
		{
			...
			if(backendManager.editClient(clientNameTextBox.getText(), emailAddressTextBox.getText(), phoneNumberTextBox.getText(), mClientID))
				dispose();
		}
	}
}  